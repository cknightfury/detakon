...
The value provided to the ``lang`` key should be the 2 character `ISO 639 <https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes>`_ code, followed by a dash (-) followed by a 2 or 3 character `ISO 3166 <https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes>`_ code.
